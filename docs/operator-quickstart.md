# Operator Quickstart — Fibre-Crop-Growing Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0116** (`cloud-itonami-isic-0116`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0116.git
cd cloud-itonami-isic-0116
```
...
- Likely source path: `fibreops.governor.cljc`
