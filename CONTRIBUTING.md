...
**Maturity: `:implemented`** — `src/fibreops/` implements the reference
FibreOpsAdvisor / FieldOperationsGovernor actor as a synchronous stub
...
crop/jurisdiction reference-data expansion in `fibreops.facts`. Open
